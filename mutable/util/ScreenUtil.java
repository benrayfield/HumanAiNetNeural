...
public class ScreenUtil{
	...
	*/
	...
	/** opens and returns a window containing the Component, a window which System.exit when closed. */
	public static JFrame testDisplayWithSysExit(Component c){
		JFrame j = new JFrame("test display "+c);
		j.add(c);
		moveToScreenCenter(j);
		j.setVisible(true);
		return j;
	}
